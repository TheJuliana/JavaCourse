...
public class Main {
    public static void main(String[] args) {
        ...
        while (game) {
            ...
            if (board.getTakeWhite().toString().contains("wK")) {
                System.out.println("----- GAME OVER! Congratulations to the BLACK winner! -----");
                in.close();
                break;
            }
            System.out.println("Взятые Черные:"+board.getTakeBlack().toString());
             if (board.getTakeBlack().toString().contains("bK")) {
                System.out.println("----- GAME OVER! Congratulations to the WHITE winner! -----");
                in.close();
                break;
            }
